...
const ProjectCard = ({ index, name, description, image, source_code_link, client, challenge, solution }) => {
			...
			<div className="bg-tertiary p-5 rounded-2xl sm:w-[360px] w-full">
				<div className="relative w-full h-[230px]">
					...
					<div className="absolute inset-0 flex justify-end m-3 card-img_hover">
						...
						>
							<img src={link3} alt="source code" className="w-1/2 h-1/2 object-contain" />
						</div>
					</div>
				</div>
				...
				<div className="mt-5">
					...
					<p className="mt-2 mb-5 text-secondary text-[14px] line-limit-5">{description}</p>
					<button
				...
				<Modal.Body>
					<div className="space-y-8">
						<div className="bg-gray-300 rounded-lg p-6 shadow-md">
							<h2 className="text-2xl font-bold text-black mb-2">About The Client:</h2>
							<p className="text-lg leading-relaxed text-black">{client}</p>
						</div>

						<div className="bg-purple-800 rounded-lg p-6 shadow-md">
							<h2 className="text-2xl font-bold text-white mb-2">The Challenge:</h2>
							<p className="text-lg leading-relaxed text-gray-200">{challenge}</p>
						</div>

						<div className="bg-gray-300 rounded-lg p-6 shadow-md">
							<h2 className="text-2xl font-bold text-black mb-2">Our Solution:</h2>
		...
		<>
			...
			<div className="w-full flex">
				<p className="mt-3 text-secondary text-[17px] max-w-3xl leading-[30px]">
					Following projects showcases our expertise, creativity, and dedication to excellence. It reflects our ability
					to solve complex problems, work with different technologies, and manage projects effectively. we're dedicated
					to driving innovation and achieving unparalleled results for our clients.
				</p>
			</div>
			...
			<div className="mt-20 flex flex-wrap gap-7">
				...
				<Modal show={openModalofProjects} size="7xl" onClose={() => setOpenModalProjects(false)}>
