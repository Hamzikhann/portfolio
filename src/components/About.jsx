  ...
  <div className="w-full sm:w-[calc(33.33% - 16px)] max-w-[320px] m-2">
    <Tilt>
      <div className="green-pink-gradient p-[1px] rounded-[20px] shadow-card">
        ...
        <div className="bg-white rounded-b-[20px] py-4 px-4">
  ...
  return (
    <>
      ...
      >
        ...
        growth and success. We strive to deliver exceptional services, tailored
        to the unique needs of each client, while fostering creativity,
        collaboration, and excellence in everything we do. With the focus on
        customer satisfaction and technological advancement to solve real-world
